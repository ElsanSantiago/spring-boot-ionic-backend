...
--
-- Host: localhost
-- Generation Time: 21-Jan-2019 às 14:21
...
INSERT INTO `cliente` (`id`, `cpf_oucnpj`, `email`, `nome`, `tipo`) VALUES
(1, '10490175520', 'elzansantiago@gmail.com', 'Elza Maria Novais Santiago', 1),
(2, '12718954710', 'ftsantiago95@gmail.com', 'Filipe Santiago', 1);
...
(1, 'Icaraí', '24220.261', 'apto.402', 'Rua Mem de Sá', '82', 1, 1),
(2, 'Centro', '24220.261', 'Sala 402', 'Avenida Mattos', '105', 2, 1),
(3, NULL, '24220261', 'apto 402', 'Rua Mem de Sa', '82', NULL, 2);
...
(1, '2017-09-30 11:32:00', 1, 1),
(2, '2017-10-10 20:35:00', 1, 2);
